...
<head>
    ...
    <title>{{ config('app.name', 'PPOB Transaction and Report') }}</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">PPOB Transaction and Report</div>
        </a>
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pengguna" aria-expanded="true" aria-controls="collapseTwo">
            ...
            <span>Pengguna & Transaksi</span>
          </a>
          <div id="pengguna" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="{{ route('user_management.index') }}">Data Pengguna</a>
              <a class="collapse-item" href="{{ route('user_management.index_point') }}">Data Point Pengguna</a>
              <a class="collapse-item" href="{{ route('order.index') }}">Transaksi</a>
            </div>
          </div>
        </li>
        ...
        <li class="nav-item">
          ...
          <div id="report" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="{{ route('orderreport.index') }}">Data Report</a>
              {{-- <a class="collapse-item" href="{{ route('orderreport.index') }}">Data Report Filtered</a> --}}
            </div>
          </div>
        </li>
        <!-- Divider -->
